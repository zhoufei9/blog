...
class Page{
    ...
    private function url($page){
    	...
    	if(C('URL_MODEL') == 0){
    	$url=	str_replace('/index.php/index/3',"/index.php/guestbook", $this->url);
        return str_replace(urlencode('[PAGE]'), $page, $this->url);
            ...
            if(substr($this->url,0,16)=='/index.php/index'){
			$url=	str_replace('/index.php/index/3',"/index.php/guestbook", $this->url);
			$url=	str_replace('/index.php/index/[PAGE]',"/index.php/guestbook/index/pageNum/".$page,$this->url); 
			}
			else {
			...
			$url=	str_replace('/index.php/index/3',"/index.php/pageNum", $this->url);
        	return str_replace(urlencode('[PAGE]'), $page, $this->url);
        	}
        }
    }
